namespace WebApiScrapingData.Infrastructure.Utils
{
    public static class Constantes
    {
        ...
        #region Difficulties
        public const string Easy_Code = "Easy";
        public const string Easy_Libelle_FR = "Facile";
        public const string Easy_Libelle_EN = "Easy";
        public const string Easy_Libelle_ES = "Fácil";
        public const string Easy_Libelle_IT = "Facile";
        public const string Easy_Libelle_DE = "Einfach";
        public const string Easy_Libelle_RU = "Легко";
        public const string Easy_Libelle_CO = "쉬운";
        public const string Easy_Libelle_CN = "简单";
        public const string Easy_Libelle_JP = "イージー";

        public const string Normal_Code = "Normal";
        public const string Normal_Libelle_FR = "Normal";
        public const string Normal_Libelle_EN = "Normal";
        public const string Normal_Libelle_ES = "Normal";
        public const string Normal_Libelle_IT = "Normale";
        public const string Normal_Libelle_DE = "Normal";
        public const string Normal_Libelle_RU = "Нормальный";
        public const string Normal_Libelle_CO = "보통";
        public const string Normal_Libelle_CN = "正常";
        public const string Normal_Libelle_JP = "ノーマル";

        public const string Hard_Code = "Hard";
        public const string Hard_Libelle_FR = "Difficile";
        public const string Hard_Libelle_EN = "Hard";
        public const string Hard_Libelle_ES = "Difícil";
        public const string Hard_Libelle_IT = "Difficile";
        public const string Hard_Libelle_DE = "Schwer";
        public const string Hard_Libelle_RU = "твердый";
        public const string Hard_Libelle_CO = "어려움";
        public const string Hard_Libelle_CN = "难";
        public const string Hard_Libelle_JP = "ハード";

        public const string Expert_Code = "Expert";
        public const string Expert_Libelle_FR = "Expert";
        public const string Expert_Libelle_EN = "Expert";
        public const string Expert_Libelle_ES = "Experto";
        public const string Expert_Libelle_IT = "Esperto";
        public const string Expert_Libelle_DE = "Experte";
        public const string Expert_Libelle_RU = "Эксперт";
        public const string Expert_Libelle_CO = "전문가";
        public const string Expert_Libelle_CN = "专家级";
        public const string Expert_Libelle_JP = "エキスパート";
        #endregion

        #region Code Type Question
        public const string QTypPok_Code = "Pok";
        public const string QTypPok_Libelle_FR = "Quel est ce pokémon?";
        public const string QTypPok_Libelle_EN = "What is this pokemon?";
        public const string QTypPok_Libelle_ES = "¿Qué es este pokémon?";
        public const string QTypPok_Libelle_IT = "Che cos'è questo Pokemon?";
        public const string QTypPok_Libelle_DE = "Was ist dieses Pokemon?";
        public const string QTypPok_Libelle_RU = "Что это за покемон?";
        public const string QTypPok_Libelle_CO = "이 포켓몬은 무엇인가요?";
        public const string QTypPok_Libelle_CN = "这只小精灵是什么？";
        public const string QTypPok_Libelle_JP = "このポケモンは何ですか？";

        public const string QTypPokTalentVarious_Code = "TypPokTalentVarious";
        public const string QTypPokTalentVarious_Libelle_FR = "Quel sont le ou les talents de ce pokémon?";
        public const string QTypPokTalentVarious_Libelle_EN = "What are this pokemon's talents?";
        public const string QTypPokTalentVarious_Libelle_ES = "¿Cuáles son los talentos de este pokémon?";
        public const string QTypPokTalentVarious_Libelle_IT = "Quali sono i suoi talenti?";
        public const string QTypPokTalentVarious_Libelle_DE = "Was sind die Talente dieses Pokemons?";
        public const string QTypPokTalentVarious_Libelle_RU = "Какие у этого покемона таланты?";
        public const string QTypPokTalentVarious_Libelle_CO = "이 포켓몬의 재능은 무엇인가요?";
        public const string QTypPokTalentVarious_Libelle_CN = "这只小精灵的天赋是什么？";
        public const string QTypPokTalentVarious_Libelle_JP = "このポケモンの才能は何ですか？";


        public const string QTypPokFamilyVarious_Code = "PokFamilyVarious";
        public const string QTypPokFamilyVarious_Libelle_FR = "Quel sont le ou les évolutions de ce pokémon?";
        public const string QTypPokFamilyVarious_Libelle_EN = "What are this pokemon's evolutions?";
        public const string QTypPokFamilyVarious_Libelle_ES = "¿Cuáles son las evoluciones de este pokémon?";
        public const string QTypPokFamilyVarious_Libelle_IT = "Quali sono le evoluzioni di questo Pokémon?";
        public const string QTypPokFamilyVarious_Libelle_DE = "Was sind die Entwicklungen dieses Pokémon?";
        public const string QTypPokFamilyVarious_Libelle_RU = "Какие у этого покемона эволюции?";
        public const string QTypPokFamilyVarious_Libelle_CO = "이 포켓몬의 진화는 무엇인가요?";
        public const string QTypPokFamilyVarious_Libelle_CN = "这只神奇宝贝有哪些进化？";
        public const string QTypPokFamilyVarious_Libelle_JP = "このポケモンの進化は？";


        public const string QTypPokTypVarious_Code = "PokTypVarious";
        public const string QTypPokTypVarious_Libelle_FR = "Quel sont le ou les pokémons de ce type?";
        public const string QTypPokTypVarious_Libelle_EN = "Which Pokémon on this list have this type?";
        public const string QTypPokTypVarious_Libelle_ES = "¿Qué Pokémon de esta lista tienen este tipo?";
        public const string QTypPokTypVarious_Libelle_IT = "Quali Pokémon di questa lista hanno questo tipo?";
        public const string QTypPokTypVarious_Libelle_DE = "Welche Pokémon auf dieser Liste haben diesen Typ?";
        public const string QTypPokTypVarious_Libelle_RU = "Какие покемоны из этого списка имеют этот тип?";
        public const string QTypPokTypVarious_Libelle_CO = "이 목록에 있는 포켓몬 중 이 타입을 가진 포켓몬은 무엇인가요?";
        public const string QTypPokTypVarious_Libelle_CN = "此列表中的哪些神奇宝贝拥有此类型？";
        public const string QTypPokTypVarious_Libelle_JP = "このポケモンのタイプは？";


        public const string QTypTypPok_Code = "TypPok";
        public const string QTypTypPok_Libelle_FR = "Quel est le type principal de ce pokémon?";
        public const string QTypTypPok_Libelle_EN = "What is this pokémon's main type?";
        public const string QTypTypPok_Libelle_ES = "¿Cuál es el tipo principal de este pokémon?";
        public const string QTypTypPok_Libelle_IT = "Qual è il tipo principale di questo Pokémon?";
        public const string QTypTypPok_Libelle_DE = "Was ist der Haupttyp dieses Pokémon?";
        public const string QTypTypPok_Libelle_RU = "Какой основной тип этого покемона?";
        public const string QTypTypPok_Libelle_CO = "이 포켓몬의 주요 타입은 무엇인가요?";
        public const string QTypTypPok_Libelle_CN = "这只神奇宝贝的主要类型是什么？";
        public const string QTypTypPok_Libelle_JP = "このポケモンのメインタイプは何ですか？";


        public const string QTypTypPokVarious_Code = "TypPokVarious";
        public const string QTypTypPokVarious_Libelle_FR = "Quel sont le ou les types de ce pokémon?";
        public const string QTypTypPokVarious_Libelle_EN = "What type(s) does this pokemon have?";
        public const string QTypTypPokVarious_Libelle_ES = "¿Qué tipo(s) tiene este pokémon?";
        public const string QTypTypPokVarious_Libelle_IT = "Che tipo/i ha questo Pokémon?";
        public const string QTypTypPokVarious_Libelle_DE = "Welche(n) Typ(en) hat dieses Pokémon?";
        public const string QTypTypPokVarious_Libelle_RU = "Какой тип (типы) есть у этого покемона?";
        public const string QTypTypPokVarious_Libelle_CO = "이 포켓몬은 어떤 타입을 가지고 있나요?";
        public const string QTypTypPokVarious_Libelle_CN = "这只神奇宝贝有什么类型？";
        public const string QTypTypPokVarious_Libelle_JP = "このポケモンのタイプは何ですか？";


        public const string QTypWeakPokVarious_Code = "TypWeakPokVarious";
        public const string QTypWeakPokVarious_Libelle_FR = "Quel sont le ou les faiblesses de ce pokémon?";
        public const string QTypWeakPokVarious_Libelle_EN = "What are this pokemon's weaknesses?";
        public const string QTypWeakPokVarious_Libelle_ES = "¿Cuáles son los puntos débiles de este pokémon?";
        public const string QTypWeakPokVarious_Libelle_IT = "Quali sono le debolezze di questo Pokémon?";
        public const string QTypWeakPokVarious_Libelle_DE = "Was sind die Schwächen dieses Pokémon?";
        public const string QTypWeakPokVarious_Libelle_RU = "Каковы слабые стороны этого покемона?";
        public const string QTypWeakPokVarious_Libelle_CO = "이 포켓몬의 약점은 무엇인가요?";
        public const string QTypWeakPokVarious_Libelle_CN = "这只神奇宝贝的弱点是什么？";
        public const string QTypWeakPokVarious_Libelle_JP = "このポケモンの弱点は何ですか？";


        public const string QTypTyp_Code = "Typ";
        public const string QTypTyp_Libelle_FR = "Quel est-ce type?";
        public const string QTypTyp_Libelle_EN = "What is this type?";
        public const string QTypTyp_Libelle_ES = "¿Qué es este tipo?";
        public const string QTypTyp_Libelle_IT = "Che cos'è questo tipo?";
        public const string QTypTyp_Libelle_DE = "Was ist dieser Typ?";
        public const string QTypTyp_Libelle_RU = "Что это за тип?";
        public const string QTypTyp_Libelle_CO = "이 타입은 무엇인가요?";
        public const string QTypTyp_Libelle_CN = "这是什么类型？";
        public const string QTypTyp_Libelle_JP = "このタイプは何ですか？";


        public const string QTypPokDesc_Code = "PokDesc";
        public const string QTypPokDesc_Libelle_FR = "Trouver la description du pokémon";
        public const string QTypPokDesc_Libelle_EN = "Find pokemon description";
        public const string QTypPokDesc_Libelle_ES = "Buscar descripción de pokémon";
        public const string QTypPokDesc_Libelle_IT = "Trova la descrizione del pokémon";
        public const string QTypPokDesc_Libelle_DE = "Pokemon-Beschreibung finden";
        public const string QTypPokDesc_Libelle_RU = "Найти описание покемона";
        public const string QTypPokDesc_Libelle_CO = "포켓몬 설명 찾기";
        public const string QTypPokDesc_Libelle_CN = "查找小精灵描述";
        public const string QTypPokDesc_Libelle_JP = "ポケモンの説明を探す";


        public const string QTypPokDescReverse_Code = "PokDescReverse";
        public const string QTypPokDescReverse_Libelle_FR = "Trouver le bon pokémon";
        public const string QTypPokDescReverse_Libelle_EN = "Find the right pokemon";
        public const string QTypPokDescReverse_Libelle_ES = "Encuentra el pokémon correcto";
        public const string QTypPokDescReverse_Libelle_IT = "Trova il pokémon giusto";
        public const string QTypPokDescReverse_Libelle_DE = "Finde das richtige Pokemon";
        public const string QTypPokDescReverse_Libelle_RU = "Найдите нужного покемона";
        public const string QTypPokDescReverse_Libelle_CO = "적합한 포켓몬 찾기";
        public const string QTypPokDescReverse_Libelle_CN = "找到正确的神奇宝贝";
        public const string QTypPokDescReverse_Libelle_JP = "このポケモンを探す";


        public const string QTypPokTalent_Code = "PokTalent";
        public const string QTypPokTalent_Libelle_FR = "Quel sont le ou les talents de ce pokémon?";
        public const string QTypPokTalent_Libelle_EN = "What are this pokemon's talents?";
        public const string QTypPokTalent_Libelle_ES = "¿Cuáles son los talentos de este pokémon?";
        public const string QTypPokTalent_Libelle_IT = "Quali sono i talenti di questo Pokemon?";
        public const string QTypPokTalent_Libelle_DE = "Welches sind die Talente dieses Pokemons?";
        public const string QTypPokTalent_Libelle_RU = "Какие у этого покемона таланты?";
        public const string QTypPokTalent_Libelle_CO = "이 포켓몬의 특성은 무엇인가요?";
        public const string QTypPokTalent_Libelle_CN = "这只小精灵的天赋是什么？";
        public const string QTypPokTalent_Libelle_JP = "このポケモンの才能は何ですか？";


        public const string QTypPokTalentReverse_Code = "PokTalentReverse";
        public const string QTypPokTalentReverse_Libelle_FR = "Trouver le bon talent";
        public const string QTypPokTalentReverse_Libelle_EN = "Find the right talent";
        public const string QTypPokTalentReverse_Libelle_ES = "Encuentra el talento correcto";
        public const string QTypPokTalentReverse_Libelle_IT = "Trova il talento giusto";
        public const string QTypPokTalentReverse_Libelle_DE = "Finde das richtige Talent";
        public const string QTypPokTalentReverse_Libelle_RU = "Найдите нужный талант";
        public const string QTypPokTalentReverse_Libelle_CO = "적합한 특성 찾기";
        public const string QTypPokTalentReverse_Libelle_CN = "找到正确的天赋";
        public const string QTypPokTalentReverse_Libelle_JP = "正しい才能を見つける";


        public const string QTypPokStat_Code = "PokStat";
        public const string QTypPokStat_Libelle_FR = "Quel est la stat {0} de {1}?";
        public const string QTypPokStat_Libelle_EN = "What is the {0} statistic of {1}?";
        public const string QTypPokStat_Libelle_ES = "¿Cuál es la estadística {0} de {1}?";
        public const string QTypPokStat_Libelle_IT = "Qual è la statistica {0} di {1}?";
        public const string QTypPokStat_Libelle_DE = "Was ist die {0}-Statistik von {1}?";
        public const string QTypPokStat_Libelle_RU = "Какова статистика {0} у {1}?";
        public const string QTypPokStat_Libelle_CO = "{1} 의 {0} 능력치는 무엇인가요?";
        public const string QTypPokStat_Libelle_CN = "{1}的{0}属性是什么？";
        public const string QTypPokStat_Libelle_JP = "{1}の{0}のステータスは何ですか？";


        public const string QTypTalent_Code = "Talent";
        public const string QTypTalent_Libelle_FR = "Trouver la description du talent";
        public const string QTypTalent_Libelle_EN = "Find the talent description";
        public const string QTypTalent_Libelle_ES = "Encuentra la descripción del talento";
        public const string QTypTalent_Libelle_IT = "Trova la descrizione del talento";
        public const string QTypTalent_Libelle_DE = "Finde die Talentbeschreibung";
        public const string QTypTalent_Libelle_RU = "Найти описание таланта";
        public const string QTypTalent_Libelle_CO = "특성 설명 찾기";
        public const string QTypTalent_Libelle_CN = "查找天赋描述";
        public const string QTypTalent_Libelle_JP = "才能の説明を探す";


        public const string QTypTalentReverse_Code = "TalentReverse";
        public const string QTypTalentReverse_Libelle_FR = "Trouver le bon talent";
        public const string QTypTalentReverse_Libelle_EN = "Find the right talent";
        public const string QTypTalentReverse_Libelle_ES = "Encuentra el talento correcto";
        public const string QTypTalentReverse_Libelle_IT = "Trova il talento giusto";
        public const string QTypTalentReverse_Libelle_DE = "Finde das richtige Talent";
        public const string QTypTalentReverse_Libelle_RU = "Найдите нужный талант";
        public const string QTypTalentReverse_Libelle_CO = "적합한 특성 찾기";
        public const string QTypTalentReverse_Libelle_CN = "找到正确的天赋";
        public const string QTypTalentReverse_Libelle_JP = "正しい才能を見つける";
        #endregion
